...
function validateInput(evt) {
    ...
    if(
        ...
        // <p class="text-red-500">Insira um valor numérico acima de 0</p>

        const errorTextElement = document.createElement('p'); //<p>
        errorTextElement.classList.add('text-red-500'); //<p class="text-red-500"
        errorTextElement.innerText = "Insira um valor numérico acima de zero";
